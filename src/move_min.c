// This code is automatically generated from src/move.c
#include <stdio.h>
#include <mpi.h>
#include <assert.h>
#include "msg.h"
...
static int sendrecv_particles(const int dix, ParticleMinimum* const buf, const int nbuf, Snapshot* const particles);

void move_particles2_min(Snapshot* const particles, const float BoxSize, void* const vbuf, const size_t vsize)
{
...
int sendrecv_particles(const int dix, ParticleMinimum* const buf, const int nbuf, Snapshot* const particles)
{
  ParticleMinimum* const p= particles->p;
  const int np_local= particles->np_local;
